...
using ASP_NET_12._TaskFlow_Validation_Global_exception_handler.Data;
...
using TaskStatus = ASP_NET_12._TaskFlow_Validation_Global_exception_handler.Models.TaskStatus;

namespace ASP_NET_12._TaskFlow_Validation_Global_exception_handler.Services;
...
public class TaskItemService : ITaskItemService
{
    ...
    public async Task<PagedResult<TaskItemResponseDto>> GetPagedAsync(TaskItemQueryParams queryParams)
    {
        ...
        var totalCount = await _context.TaskItems.CountAsync();
